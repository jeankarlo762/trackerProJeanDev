...
import 'cadastro_ticket_mobile_model.dart';
export 'cadastro_ticket_mobile_model.dart';

class CadastroTicketMobileWidget extends StatefulWidget {
  const CadastroTicketMobileWidget({
    super.key,
  ...
  @override
  State<CadastroTicketMobileWidget> createState() =>
      _CadastroTicketMobileWidgetState();
}

class _CadastroTicketMobileWidgetState extends State<CadastroTicketMobileWidget>
    with TickerProviderStateMixin {
  late CadastroTicketMobileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroTicketMobileModel());
                    ...
                    if (_model.modalColab == false)
                      FutureBuilder<List<AgentsAgentRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return Container(
                            width: MediaQuery.sizeOf(context).width * 1.024,
                            height: 824.4,
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                _model.viewCadastroColab = true;
                                                _model.viewResponsavel = false;
                                                safeSetState(() {});
                                              },
                                              text: 'Cadastrar',
