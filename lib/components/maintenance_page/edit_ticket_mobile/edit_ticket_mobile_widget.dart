...
import 'edit_ticket_mobile_model.dart';
export 'edit_ticket_mobile_model.dart';

class EditTicketMobileWidget extends StatefulWidget {
  const EditTicketMobileWidget({
    super.key,
    this.idTicket,
  });
  ...
  @override
  State<EditTicketMobileWidget> createState() => _EditTicketMobileWidgetState();
}

class _EditTicketMobileWidgetState extends State<EditTicketMobileWidget> {
  late EditTicketMobileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditTicketMobileModel());
                            ...
                            Padding(
                              ...
                              child: FutureBuilder<List<TicketHistoryRow>>(
                                future: (_model.requestCompleter2 ??= Completer<
                                      ...
                                      ..complete(TicketHistoryTable().queryRows(
                                        queryFn: (q) => q
                                            .eqOrNull(
                                              'ticket_id',
                                              widget!.idTicket,
