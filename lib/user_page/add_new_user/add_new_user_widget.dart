...
class _AddNewUserWidgetState extends State<AddNewUserWidget>
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UserProfilesRow>>(
      future: (_model.requestCompleter ??= Completer<List<UserProfilesRow>>()
            ..complete(UserProfilesTable().queryRows(
              queryFn: (q) => q,
            )))
          .future,
      builder: (context, snapshot) {
        ...
        List<UserProfilesRow> overlayUserProfilesRowList = snapshot.data!;
                                        ...
                                        child: Container(
                                          ...
                                          child: CachedNetworkImage(
                                            ...
                                            fadeOutDuration:
                                                Duration(milliseconds: 500),
                                            imageUrl: _model
                                                .uploadedFileUrl_uploadFotoAddUser,
                                            fit: BoxFit.fitWidth,
                                          ),
                                        ),
                                      ),
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (selectedMedia != null &&
                                          ...
                                          safeSetState(() => _model
                                                  .isDataUploading_uploadFotoAddUser =
                                              true);
                                          ...
                                          try {
                                            ...
                                            ScaffoldMessenger.of(context)
                                                .hideCurrentSnackBar();
                                            _model.isDataUploading_uploadFotoAddUser =
                                                false;
                                          }
                                          if (selectedUploadedFiles.length ==
                                              ...
                                              downloadUrls.length ==
                                                  selectedMedia.length) {
                                            safeSetState(() {
                                              _model.uploadedLocalFile_uploadFotoAddUser =
                                                  selectedUploadedFiles.first;
                                              _model.uploadedFileUrl_uploadFotoAddUser =
                                                  downloadUrls.first;
                                            });
                                            showUploadMessage(
                                                context, 'Success!');
                                  ...
                                  children: [
                                    Expanded(
                                      child: TextFormField(
                                        ...
                                        focusNode:
                                            _model.inputFirstNameFocusNode,
                                        autofocus: true,
                                        obscureText: false,
