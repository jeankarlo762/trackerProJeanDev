...
class AddNewUserModel extends FlutterFlowModel<AddNewUserWidget> {
  ...
  bool isDataUploading_uploadFotoAddUser = false;
  FFUploadedFile uploadedLocalFile_uploadFotoAddUser =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_uploadFotoAddUser = '';

  // Stores action output result for [Backend Call - Update Row(s)] action in Button widget.
  List<UserProfilesRow>? updateFoto;
  Completer<List<UserProfilesRow>>? requestCompleter;
