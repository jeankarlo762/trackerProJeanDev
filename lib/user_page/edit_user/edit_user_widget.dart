    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [Colors.transparent, Color(0xFF0D121D)],
          stops: [0.0, 1.0],
                      ...
                      Column(
                        ...
                        children: [
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (selectedMedia != null &&
                                      ...
                                      safeSetState(() => _model
                                              .isDataUploading_uploadFotoEditUser =
                                          true);
                                      ...
                                      try {
                                        ...
                                        ScaffoldMessenger.of(context)
                                            .hideCurrentSnackBar();
                                        _model.isDataUploading_uploadFotoEditUser =
                                            false;
                                      }
                                      if (selectedUploadedFiles.length ==
                                          ...
                                          downloadUrls.length ==
                                              selectedMedia.length) {
                                        safeSetState(() {
                                          _model.uploadedLocalFile_uploadFotoEditUser =
                                              selectedUploadedFiles.first;
                                          _model.uploadedFileUrl_uploadFotoEditUser =
                                              downloadUrls.first;
                                        });
                                    ...
                                    _model.updateFoto =
                                      ...
                                      data: {
                                        'avatar_url': _model
                                            .uploadedFileUrl_uploadFotoEditUser,
                                      },
                                ...
                                Expanded(
                                  child: TextFormField(
                                    controller:
                                      ...
                                      text: containerCollaboratorsRowList
                                          .firstOrNull?.nome,
                                    ),
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: TextFormField(
                                    controller:
                                        _model.inputPositionTextController ??=
                                            TextEditingController(
                                      text: containerCollaboratorsRowList
                                          .firstOrNull?.position,
                                    ),
                                    focusNode: _model.inputPositionFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Cargo',
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 16.0, 16.0, 0.0),
                            child: FutureBuilder<List<ClientsSiteRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return FlutterFlowDropDown<int>(
                                  controller:
                                      _model.inputDepartamentValueController ??=
                                  ...
                                  onChanged: (val) => safeSetState(
                                      () => _model.inputDepartamentValue = val),
                                  width: double.infinity,
                                  height: 58.0,
                                  searchHintTextStyle:
                                      FlutterFlowTheme.of(context)
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  _model.response = await actions.verificaErro(
                                    () async {
                                      await CollaboratorsTable().update(
                                        data: {
                                          'nome': _model
                                              ...
                                              .text,
                                          'sobrenome': _model
                                              .inputLastNameTextController.text,
                                          'email': _model
                                              .inputEmailTextController.text,
                                          'telefone': _model
                                              .inputPhoneTextController.text,
                                          'position': _model
                                              .inputPositionTextController.text,
                                          'site_id':
                                              _model.inputDepartamentValue,
                                          'client_id': FFAppState().client.id,
                                        },
                                        matchingRows: (rows) => rows.eqOrNull(
                                          'id',
                                          widget!.idCollaborator,
